"""
Arduino Robot Bringup Launch Dosyası
Seri port üzerinden Arduino ile haberleşme (ROSArduinoBridge protokolü)
...
Kullanım:
ros2 launch my_robot_bringup arduino/arduino_robot_bringup.launch.py serial_port:=/dev/ttyUSB0
"""
